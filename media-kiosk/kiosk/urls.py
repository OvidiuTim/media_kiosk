...
urlpatterns = [
    ...
    path("materials/processing-status/", views.media_processing_status, name="media_processing_status"),
    path("materials/<int:pk>/retry/", views.media_retry, name="media_retry"),
    path("materials/<int:pk>/optimize/", views.media_optimize, name="media_optimize"),
